...
def takeapicture():
    ...
    for col in range(6):
        ...
        for row in range(4):
            ...
            if avg_R < 120 and avg_G < 170 and avg_B > 120:  # 로봇

                myMaze[col][row] = 4

            elif avg_R < 110 and avg_G < 110 and avg_B < 110:  # 까만 벽

                myMaze[col][row] = 0

            elif avg_G < 140 and avg_B < 140:  # 경유지

                myMaze[col][row] = 2

            elif avg_R > 110 and avg_G > 110 and avg_B > 110:  # 일반 길
